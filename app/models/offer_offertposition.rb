class OfferOffertposition < ApplicationRecord
  ...
  def total_brutto
    self.eng_elplanung + self.eng_planung_sw + self.eng_ibn_bauleitung + self.sps_total_brutto + self.sch_total_brutto + self.elinst_total_brutto
  end

  def total_netto
    self.eng_elplanung + self.eng_planung_sw + self.eng_ibn_bauleitung + self.sps_total_netto + self.sch_total_netto + self.elinst_total_netto
  end
end
